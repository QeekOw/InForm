...
// Every extracted value as key, label, value and unit.
export const READING_ROWS: {
  ...
  { key: "weight_kg", label: "Weight", unit: "kg", value: (r) => r.weight_kg },
  { key: "lean_body_mass_kg", label: "Lean Body Mass", unit: "kg", value: (r) => r.lean_body_mass_kg },
  { key: "percent_body_fat", label: "Percent Body Fat", unit: "%", value: (r) => r.percent_body_fat },
  { key: "skeletal_muscle_mass_kg", label: "Skeletal Muscle Mass", unit: "kg", value: (r) => r.skeletal_muscle_mass_kg },
  { key: "basal_metabolic_rate_kcal", label: "Basal Metabolic Rate", unit: "kcal", value: (r) => r.basal_metabolic_rate_kcal },
  { key: "visceral_fat_level", label: "Visceral Fat Level", unit: "level", value: (r) => r.visceral_fat_level },
  { key: "segmental_lean.left_arm_kg", label: "Left Arm", unit: "kg", value: (r) => r.segmental_lean.left_arm_kg },
  { key: "segmental_lean.right_arm_kg", label: "Right Arm", unit: "kg", value: (r) => r.segmental_lean.right_arm_kg },
  { key: "segmental_lean.left_leg_kg", label: "Left Leg", unit: "kg", value: (r) => r.segmental_lean.left_leg_kg },
  { key: "segmental_lean.right_leg_kg", label: "Right Leg", unit: "kg", value: (r) => r.segmental_lean.right_leg_kg },
  { key: "segmental_lean.trunk_kg", label: "Trunk", unit: "kg", value: (r) => r.segmental_lean.trunk_kg },
];
